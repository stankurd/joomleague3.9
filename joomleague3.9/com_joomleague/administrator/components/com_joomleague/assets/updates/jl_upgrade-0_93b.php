...
function Update_Tables($updates,$tablename)
{
	$db = JFactory::getDbo();
	$queries=array();
	$tables=$updates[$tablename][0]['tablename'];

	echo JText::sprintf('Updating table [%s]','<b>'.$tables.'</b>');

	$fields=$db->getTableColumns($tables);
	$fieldlist=implode(",",array_keys($fields[ $tables ]));
	...
	foreach ($updates[$tablename] as $update)
	{
		if ((isset ($update['field'])) && (!is_null($update['field'])))
		{
			...
			if (!in_array($update['field'],array_keys($fields[ $tables ])))
			{
				if ($after!="")
				{
					if (in_array($after,array_keys($fields[ $tables ])))
					{
						$after="AFTER `".$after."`";
					}
					else
				...
				$queries[]=array(	$update['action']." `".$tables."` ".$update['job']." `".$update['field']."` " .
									$update['values']." ".$after,
									JText::sprintf('COM_JOOMLEAGUE_DB_UPDATE_ADDING_FIELD_TO_TABLE','<b>'.$update['field'].'</b>'));
				$fields[ $tables ][$update['field']]="#";
			}
		}
	}
...
function Change_Table_Columns($updates,$tablename)
{
	...
	foreach ($updates[$tablename] as $update)
	{
		if ((isset ($update['field'])) && (!is_null($update['field'])))
		{
			$queries[]=array(	$update['action']." `".$tables."` ".$update['job']." `" .
...
function Delete_Table_Columns($dUpdates,$tablename)
{
	$db = JFactory::getDbo();
	$queries=array();
	$tables=$dUpdates[$tablename][0]['tablename'];
...
function addGhostPlayer()
{
	...
	echo JText::sprintf('COM_JOOMLEAGUE_DB_UPDATE_ADDING_GHOSTPERSON','<b>'.'#__joomleague_person'.'</b>');
...
function LeaguesToLeague()
{
	...
	echo JText::sprintf('COM_JOOMLEAGUE_DB_UPDATE_COPIED_X_OF_Y_RECORDS',$i,count($leagues));
	echo '</b><br /><br />';
...
function SeasonsToSeason()
{
	...
	echo '<br /><b style="color:'.$color.';" >';
	echo JText::sprintf('COM_JOOMLEAGUE_DB_UPDATE_COPIED_X_OF_Y_RECORDS',$i,count($seasons));
	echo '</b><br /><br />';
...
*/      
	...
	echo '<br /><b style="color:'.$color.';" >';
	echo JText::sprintf('COM_JOOMLEAGUE_DB_UPDATE_COPIED_X_OF_Y_RECORDS',$i,count($eventtypes));
	echo '</b><br /><br />';
...
*/ 
	...
	echo '<br /><b style="color:'.$color.';" >';
	echo JText::sprintf('COM_JOOMLEAGUE_DB_UPDATE_COPIED_X_OF_Y_RECORDS',$i,count($positions));
	echo '</b><br /><br />';
...
*/
  $posevents=$db->loadObjectList();
	...
	echo '<br /><b style="color:'.$color.';" >';
	echo JText::sprintf('COM_JOOMLEAGUE_DB_UPDATE_COPIED_X_OF_Y_RECORDS',$i,count($posevents));
	echo '</b><br /><br />';
	return '';
}
...
function PlaygroundsToPlayground()
{
	...
	echo '<br /><b style="color:'.$color.';" >';
	echo JText::sprintf('COM_JOOMLEAGUE_DB_UPDATE_COPIED_X_OF_Y_RECORDS',$i,count($playgrounds));
	echo '</b><br /><br />';
...
function ClubsToClub()
{
	...
	echo '<br /><b style="color:'.$color.';" >';
	echo JText::sprintf('COM_JOOMLEAGUE_DB_UPDATE_COPIED_X_OF_Y_RECORDS',$i,count($clubs));
	echo '</b><br /><br />';
	return '';
}
...
//echo '<pre>'.print_r($query,true).'</pre>';
	...
	echo '<br /><b style="color:'.$color.';" >';
	echo JText::sprintf('COM_JOOMLEAGUE_DB_UPDATE_COPIED_X_OF_Y_RECORDS',$i,count($teams));
	echo '</b><br /><br />';
...
//				if ( !$dResult=$db->loadResult() ) // get new Position id...
	...
	echo '<br /><b style="color:'.$color.';" >';
	echo JText::sprintf('COM_JOOMLEAGUE_DB_UPDATE_COPIED_X_OF_Y_RECORDS',$i,count($players));
	echo '</b><br /><br />';
...
function RefereesToPerson()
{
	...
	echo '<br /><b style="color:'.$color.';" >';
	echo JText::sprintf('COM_JOOMLEAGUE_DB_UPDATE_COPIED_X_OF_Y_RECORDS',$i,count($referees));
	echo '</b><br /><br />';
...
function JoomleagueToProject()
{
	...
	echo '<br /><b style="color:'.$color.';" >';
	echo JText::sprintf('COM_JOOMLEAGUE_DB_UPDATE_COPIED_X_OF_Y_RECORDS',$i,count($projects));
	echo '</b><br /><br />';
...
function DivisionsToDivision()
{
	...
	echo '<br /><b style="color:'.$color.';" >';
	echo JText::sprintf('COM_JOOMLEAGUE_DB_UPDATE_COPIED_X_OF_Y_RECORDS',$i,count($divisions));
	echo '</b><br /><br />';
...
function PosjoomleagueToProjectposition()
{
	...
	echo '<br /><b style="color:'.$color.';" >';
	echo JText::sprintf('COM_JOOMLEAGUE_DB_UPDATE_COPIED_X_OF_Y_RECORDS',$i,count($projectpositions));
	echo '</b><br /><br />';
	return '';
}
...
function RoundsToRound()
{
	...
	echo '<br /><b style="color:'.$color.';" >';
	echo JText::sprintf('COM_JOOMLEAGUE_DB_UPDATE_COPIED_X_OF_Y_RECORDS',$i,count($rounds));
	echo '</b><br /><br />';
...
function TeamjoomleagueToProjectteam()
{
	...
	echo '<br /><b style="color:'.$color.';" >';
	echo JText::sprintf('COM_JOOMLEAGUE_DB_UPDATE_COPIED_X_OF_Y_RECORDS',$i,count($teamtools));
	echo '</b><br /><br />';
	return '';
}
...
*/					
	...
	echo '<br /><b style="color:'.$color.';" >'.JText::sprintf('COM_JOOMLEAGUE_DB_UPDATE_COPIED_X_OF_Y_RECORDS',$i,count($playertools)).'</b><br /><br />';
	return '';
}
...
*/        
	...
	echo '<br /><b style="color:'.$color.';" >'.JText::sprintf('COM_JOOMLEAGUE_DB_UPDATE_COPIED_X_OF_Y_RECORDS',$i,count($stafftools)).'</b><br /><br />';
	return '';
}
...
function PredictionGameToPredictionGame()
{
	...
	echo '<br /><b style="color:'.$color.';" >'.JText::sprintf('COM_JOOMLEAGUE_DB_UPDATE_COPIED_X_OF_Y_RECORDS',$i,count($predictiongames)).'</b><br /><br />';
...
function PredictionGameAdminsToPredictionAdmin()
{
	...
	echo '<br /><b style="color:'.$color.';" >'.JText::sprintf('COM_JOOMLEAGUE_DB_UPDATE_COPIED_X_OF_Y_RECORDS',$i,count($predictiongameadmins)).'</b><br /><br />';
	return '';
}
...
function PredictionGameProjectToPredictionProject()
{
	...
	echo '<br /><b style="color:'.$color.';" >'.JText::sprintf('COM_JOOMLEAGUE_DB_UPDATE_COPIED_X_OF_Y_RECORDS',$i,count($predictiongameprojects)).'</b><br /><br />';
	return '';
}
...
function TipMembersToPredictionMember()
{
	...
	echo '<br /><br /><b style="color:'.$color.';" >'.JText::sprintf('COM_JOOMLEAGUE_DB_UPDATE_COPIED_X_OF_Y_RECORDS',$i,count($predictiongamemembers)).'</b><br /><br />';
