...
require_once(JPATH_ADMINISTRATOR.DS.'components'.DS.'com_joomleague'.DS.'models'.DS.'ajax.php');
require_once(JPATH_ADMINISTRATOR.DS.'components'.DS.'com_joomleague'.DS.'helpers'.DS.'joomleague.php');  
 ...
 * @since1.5
 */
class JFormFieldMDependSQL extends FormField
{
	/**
	 * field name
	 *
...
{
    case 'project':
    $script[] = "						url: 'index.php?option=com_joomleague&format=json&dbase=".$cfg_which_database."&slug=".$slug."&task=ajax.".$ajaxtask."&project=".$project_id."&".$depends."=' + value,";
    break;
    case 'club':
    $script[] = "						url: 'index.php?option=com_joomleague&format=json&dbase=".$cfg_which_database."&slug=".$slug."&task=ajax.".$ajaxtask."&country=".$key_value."&".$depends."=' + value,";
    break;
    default:
    $script[] = "						url: url,";
    break;
...
$script[] = "});";       
    ...
    Factory::getDocument()->addScriptDeclaration(implode("\n", $script));
        ...
        $result = joomleagueModelAjax::$ajaxtask($value,$required,$slug);
