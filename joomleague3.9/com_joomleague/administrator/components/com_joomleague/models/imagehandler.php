<?php
/** joomleague ein Programm zur Verwaltung für Sportarten
 * @version   1.0.05
 * @file      imagehandler.php
 * @author    diddipoeler, stony, svdoldie und donclumsy (diddipoeler@gmx.de)
 * @copyright Copyright: © 2013 Fussball in Europa http://fussballineuropa.de/ All rights reserved.
 * @license   This file is part of joomleague.
 * @package   joomleague
 ...
 * @access public
 */
class JoomleagueModelImagehandler extends BaseDatabaseModel
{
	/**
	 * Pagination object
	 *
