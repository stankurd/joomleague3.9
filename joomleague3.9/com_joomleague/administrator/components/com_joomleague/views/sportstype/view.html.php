...
class JoomleagueViewSportsType extends JLGView
{
	...
	protected function addToolbar()
	{
		...
		if($isNew)
		{
			JLToolBarHelper::title(Text::_('COM_JOOMLEAGUE_ADMIN_SPORTSTYPE_ADD_NEW'),'jl-sportstypes');
		...
		{
			JLToolBarHelper::title(Text::_('COM_JOOMLEAGUE_ADMIN_SPORTSTYPE_EDIT').': '.Text::_($this->form->getValue('name')),'jl-sportstypes');
			/*ToolbarHelper::saveGroup(
			    [
			        ['apply', 'sportstype.apply'],
			        ['save', 'sportstype.save'],
