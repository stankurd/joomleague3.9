...
class JoomleagueViewpredictiongroup extends JLGView
{
	...
	*/
	...
	{	
		...
		if (!$edit)
		{
			JLToolBarHelper::title(Text::_('COM_JOOMLEAGUE_ADMIN_PREDICTIOGROUP_ADD_NEW'),'predictiongroups');
		...
		else
		{
			...
			JLToolBarHelper::title(Text::_('COM_JOOMLEAGUE_ADMIN_PREDICTIOGROUP_EDIT'),'predictiongroups');
