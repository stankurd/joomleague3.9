	...
	public function getLink($view)
	{
		...
		{								
			...
			case "teaminfo":
				...
				$link = JoomleagueHelperRoute::getTeamInfoRoute( $this->project->id, $item->team_id );
				break;				
			...
			case "teamplan":
				...
				$link = JoomleagueHelperRoute::getTeamPlanRoute( $this->project->id, $item->team_id, $this->_division_id );
				break;		
